...
export default function Sidebar({setToggleView}) {
    ...
    return (
        ...
        <h3>Our Cards</h3>
          <ul className="cards">
          <Link to="/card/1"><li><span className="indent">Student Life</span></li></Link>
          <Link to="/card/2">  <li><span className="indent">Anywhere Card</span></li></Link>
          <Link to="/card/3"> <li><span className="indent">Liquid Card</span></li></Link>
        </ul>
